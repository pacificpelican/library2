		...
		return (
			<article id="lower_article" className="page_element">
				...
				<div>
					...
					<section className="expense-form"><span className="input-span">book title: </span><input required id="input-amount" type="text" ref={this.input} /></section>
						<section className="expense-form"><span className="input-span">book year: </span><input id="input-date" type="text" ref={this.input4} /></section>
						<section className="expense-form"><span className="input-span">book url: </span><input id="payee-description" type="text" ref={this.input2} /></section>
						<section className="expense-form"><span className="input-span">book author: </span><input required id="input-description" type="text" ref={this.input3} /></section>
